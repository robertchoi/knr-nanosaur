#!/bin/bash
# Apache License 2.0
# Copyright (c) 2020, KNRobotics CO., LTD.

echo ""
echo "[Note] OS version  >>> Ubuntu Bionic(18.04)"
echo "[Note] Target ROS version >>> ROS 2 Eloquent"
...
name_ros_version=${name_ros_version:="eloquent"}
